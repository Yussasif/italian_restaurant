...
function DishCard({ dish }) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl w-[30%] shadow-md hover:scale-90 transition-all ease-in-out duration-300 dark:shadow-white/20 bg-white dark:bg-card-background-dark max-tablet:w-[90%] max-tablet:h-auto">
