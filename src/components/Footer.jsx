...
function Footer() {
    return (
        <div className=" bg-gray-100 text-gray-500 py-10  dark:bg-card-background-dark">
            <div className="px-10 grid grid-cols-5 mb-4 max-tablet:flex max-tablet:flex-col max-tablet:justify-center max-tablet:items-center max-tablet:gap-10">
               ...
               <div className=" col-span-2 flex flex-col items-center">
                <h2 className="font-bold mb-4 text-2xl text-primary max-tablet:text-center">Luce di Grano</h2>
                <p className="max-tablet:text-center">Authentic Italian flavors, cherished traditions.</p>
                </div>


            <div className="flex flex-col items-left max-tablet:items-center ">
                <h3 className="font-bold mb-4 text-xl">Explore</h3>
                <Link to="/home" className="mb-2 hover:text-primary">Home</Link>
                <Link to="/menu" className="mb-2 hover:text-primary">Menu</Link>
                <Link to="/reservation" className="mb-2 hover:text-primary">Reservations</Link>
        ...
        <hr />
        <p className="text-center mt-4">© 2026 Luce di Grano. All rights reserved.</p>
        </div>
    )
}
