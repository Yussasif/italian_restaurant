...
function App() {
  return (
    <div className="m-0 font-display">
      ...
      h-160 flex flex-col justify-center items-center text-white text-center px-4 max-phone:h-auto max-phone:py-20"
      >
        <h1
          className="font-bold tablet:text-8xl max-phone:text-4xl max-tablet:text-6xl max-phone:w-[90%] max
      ...
      <section className="pt-30 pb-10 px-20 flex justify-between items-center dark:bg-background-dark max-phone:flex-col max-phone:gap-10 max-phone:px-4 ">
        <div className="w-[50%] flex flex-col gap-6 dark:text-white max-phone:w-[80%] max-phone:items-center">
          <h2 className="text-4xl font-bold w-140 max-phone:w-full  leading-12 max-phone:text-3xl desktop:text-5xl desktop:leading-20">
      ...
      <section className="mt-30 pb-40 px-20 flex flex-col gap-10 items-center dark:bg-background-dark text-black dark:text-white max-phone:px-4">
        <h2 className="text-4xl font-bold w-140  text-center max-phone:text-3xl max-phone:w-[80%]">
